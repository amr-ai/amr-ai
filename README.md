...
<br>
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&duration=3000&pause=1000&color=36BCF7&center=true&vCenter=true&width=700&lines=AI+Engineer+%26+Data+Scientist;Machine+Learning+%7C+Deep+Learning+Developer;NLP+%7C+GenAI+%7C+LLMs+Enthusiast;Multi-Agent+Systems+%7C+LangGraph+%7C+LangChain;Building+AI+systems+that+matter)](https://git.io/typing-svg)
</div>
...
- Designing multi-agent pipelines with **LangGraph & LangChain**
...
- Cloud deployment with **AWS & Amazon SageMaker**
